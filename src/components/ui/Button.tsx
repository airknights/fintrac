...
const VARIANTS: Record<Variant, string> = {
  ...
  secondary: 'bg-zinc-800 hover:bg-zinc-700 text-gray-200 border border-zinc-700',
  danger:    'bg-red-900/60 hover:bg-red-800 text-red-300 border border-red-800',
  ghost:     'bg-transparent hover:bg-zinc-800 text-gray-400 border border-transparent',
}
